    ...
    >
      <div>
        <div className="grid relative z-[100]">
          ...
          {slice.primary.text_group.map((item, index) => ( //isso é o TextGroup do prismic

            <div key={asText(item.heading)} className="alternating-section grid h-screen place-items-center gap-x-12 md:grid-cols-2">
              <div className={clsx(index % 2 === 0 ? "col-start-1" : "md:col-start-2", "rounded-lg p-4 backdrop-blur-lg max-md:bg-white/30")}> {/* se o numero for par comece na esquerda, senao comece na direita */}
